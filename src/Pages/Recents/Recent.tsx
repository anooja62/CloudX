...
const Recent: FC = () => {
  ...
  const getIcon = (file: { mime_type: string; url: string }) => {
    ...
    if (file.mime_type.includes("image"))
      return <FaFileImage className="text-yellow-400 text-2xl" />;
    if (file.mime_type.includes("pdf"))
      return <FaFilePdf className="text-red-400 text-2xl" />;
    if (file.mime_type.includes("video"))
      return <FaFileVideo className="text-green-400 text-2xl" />;
            ...
            return (
              <div
                ...
                className={`p-4 rounded-lg text-white relative flex ${
                  isGridView
                    ? "flex-col items-center text-center bg-gray-800 w-full min-h-[120px]"
              ...
              >
                ...
                <div className="flex-1 w-full">
                  ...
                  <p
                    className={`mx-auto text-sm font-medium w-full ${
                      isGridView ? "truncate overflow-hidden" : ""
                    }`}
                  >
                    {file.file_name}
                  </p>
                  ...
                  {menuOpen === index && (
                    ...
                    >
                      ...
                      <button
                        // onClick={(e) => {
                        //   e.stopPropagation();
                        //   handleDelete(file._id); // Pass file ID to delete function
                        // }}
